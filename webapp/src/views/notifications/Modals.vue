      ...
      <CCard class="mb-4">
        ...
        <CCardBody>
          ...
          <DocsExample href="components/modal.html#static-backdrop">
            ...
            ">Launch demo modal</CButton>
            <CModal backdrop="static" :visible="visibleStaticBackdropDemo" @close="
              () => {
      ...
      <CCard class="mb-4">
        ...
        <CCardBody>
          ...
          <DocsExample href="components/modal.html#scrolling-long-content">
            ...
            ">Launch demo modal</CButton>
            <CModal :visible="visibleScrollingLongContentDemo" @close="
              () => {
          ...
          <DocsExample href="components/modal.html#scrolling-long-content">
            ...
            ">Launch demo modal</CButton>
            <CModal scrollable :visible="visibleScrollableDemo" @close="
              () => {
      ...
      <CCard class="mb-4">
        ...
        <CCardBody>
          ...
          <DocsExample href="components/modal.html#vertically-centered">
            ...
            <CModal alignment="center" scrollable :visible="visibleVerticallyCenteredScrollableDemo" @close="
              () => {
      ...
      <CCard class="mb-4">
        ...
        <CCardBody>
          ...
          <DocsExample href="components/modal.html#tooltips-and-popovers">
            ...
            ">Launch demo modal</CButton>
            <CModal :visible="tooltipsAndPopoversDemo" @close="
              () => {
      ...
      <CCard class="mb-4">
        ...
        <CCardBody>
          ...
          <DocsExample href="components/modal.html#optional-sizes">
            ...
            <CModal size="sm" :visible="smDemo" @close="
              () => {
                smDemo = false
              }
            ">
      ...
      <CCard class="mb-4">
        ...
        <CCardBody>
          ...
          <DocsExample href="components/modal.html#fullscreen-modal">
            ...
            <CModal fullscreen :visible="fullscreenDemo" @close="
              () => {
            ...
            <CModal fullscreen="sm" :visible="fullscreenSmDemo" @close="
              () => {
            ...
            <CModal fullscreen="md" :visible="fullscreenMdDemo" @close="
              () => {
            ...
            <CModal fullscreen="lg" :visible="fullscreenLgDemo" @close="
              () => {
            ...
            <CModal fullscreen="xl" :visible="fullscreenXlDemo" @close="
              () => {
            ...
            <CModal fullscreen="xxl" :visible="fullscreenXxlDemo" @close="
              () => {
